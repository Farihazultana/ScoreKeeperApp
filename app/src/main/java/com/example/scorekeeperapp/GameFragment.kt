...
import com.example.scorekeeperapp.databinding.FragmentGameBinding
...
//        Set click listeners
    ...
    //            A shot was made, now update the score
            val newScore = binding.gameFragmentTvTeam1.text.toString().toInt() + pointValue
            binding.gameFragmentTvTeam1.text = newScore.toString()

    //            Update the quarter score
            when {
                binding.gameFragmentRbQ1.isChecked -> {
    //                    Log.wtf("bsk","1-->  "+ binding.gameFragmentTvTeam1Q1.text.toString() + "pointValue: "  + pointValue)
    ...
    //    Update the shooting percentage
    team1TotalShots++
    ...
    //            A shot was made, now update the score
            val newScore = binding.gameFragmentTvTeam2.text.toString().toInt() + pointValue
            binding.gameFragmentTvTeam2.text = newScore.toString()
    ...
    private fun nextFragment(){
         ...
         val score1 = binding.gameFragmentTvTeam1.text.toString()

         val team2 = binding.gameFragmentTvTeam2Name.text.toString()
         val score2 = binding.gameFragmentTvTeam2.text.toString()
